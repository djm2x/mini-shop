...
export class UserComponent implements OnInit, OnDestroy {
  ...
  displayedColumns = ['select',  'email', 'option'];
  ...
  getPage(startIndex, pageSize, sortBy, sortDir, email,) {
    const sub = this.uow.users.getAll(startIndex, pageSize, sortBy, sortDir,  email,).subscribe(
      (r: any) => {
        console.log(r.list);
